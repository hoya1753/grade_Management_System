	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<ul class="nav navbar-top-links navbar-right">
				<!-- 사용자 이름 보이기 -->
				<li class="navbar-brand"><small>
						${sessionScope.admin_id} 관리자님 환영합니다.</small></li>
		...
		<div id="page-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<h4 style="padding-top: 10px">개설 과목 관리</h4>
					<hr>
					<div class="table-responsive list">
						<form action="ad_sj_subjectList.it" method="post">
							...
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										<td>cs009</td>
										<td>[100%국비지원]C언어 전문가 과정</td>
										<td>2017-07-01~2017-11-30</td>
										<td>0</td>
										<td><button type="submit"
												class="btn btn-default btn-xs choose">과목정보</button></td>
									</tr>
									--%>
									<c:forEach var="a" items="${list}">
										<tr>
											<td>${a.course_id}</td>
											<td>${a.course_name}</td>
											<td><span>${a.cr_start_date}</span><span>~</span><span>${a.cr_end_date}</span></td>
											<td>${a.countSub}</td>
											<td><button type="submit"
													class="btn btn-default btn-xs choose">과목정보</button></td>
										</tr>
					...
					<div style="text-align: center;">
						<form class="form-inline" method="post">
							...
							<span class="seach_info">총 <span>${length}</span>개의 과정 검색
							</span>
						</form>
					</div>

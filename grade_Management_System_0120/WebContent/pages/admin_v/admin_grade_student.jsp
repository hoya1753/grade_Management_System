...
<script>
	$(document).ready(function() {
		...
		$("button.choose").on("click", function() {			
			$("#sid").val($(this).parents("tr").children().eq(0).text());
		});
				...
				<div class="col-lg-12">
						...
						<!-- /.panel-heading -->
							<div class="table-responsive list" style="padding-top: 10px">
								<form action="ad_gr_studentCourseList.it" method="post">
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<tr>
												...
												<td><button type="submit"
														class="btn btn-default btn-xs choose" value="${s.student_id}">조회</button></td>
											</tr>
											</c:forEach>
										</tbody>
									</table>
							...
							<!-- 검색 폼 -->
								<div style="text-align: center;">
									<form class="form-inline">
										...
										<span class="seach_info">총 ${totalCount}명의 학생 검색</span>
									</form> 
								</div>
							<!-- /.table-responsive -->						
						<!-- /.panel-body -->
